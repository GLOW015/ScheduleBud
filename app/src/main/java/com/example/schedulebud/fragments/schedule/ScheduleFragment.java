...
public class ScheduleFragment extends Fragment {
    ...
    public void onViewCreated (View view,
        ...
        new TabLayoutMediator(tabLayout, viewPager2,
                (tab, position) -> {
                    tab.setText(((VPAdapter2)(viewPager2.getAdapter())).mFragmentNames[position]);
                }
        ).attach();
        weekNumber = 1;
        ...
        scheduleWeekLeft.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (weekNumber>1) {
                    weekNumber--;
        ...
        scheduleWeekRight.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (weekNumber<15) {
                    weekNumber++;
